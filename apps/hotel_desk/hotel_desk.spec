...
# PyInstaller spec for Hotel Desk Windows .exe
# Build: pyinstaller hotel_desk.spec  (run from apps/hotel_desk/)
...
exe = EXE(
    ...
    icon=None,                # Replace with 'hotel_desk.ico' if you have one
)
